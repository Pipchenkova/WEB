      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
           ...
           <?php for ($i = count($experience)-1; $i >=0; $i--): ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $experience[$i]['position']; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['from_date']; ?> - 
            <?php
            if ( $experience[$i]['to_date'] == "Current"){ ?>
            
            <span
                class="w3-tag w3-teal w3-round">Current </span>;<?php }
                else{   ?>
              <i class="fa fa-calendar fa-fw w3-margin-right"></i>
             <?php
              echo $experience[$i]['to_date'];}
              ?>
              </h6>
